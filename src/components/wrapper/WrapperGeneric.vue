<template>
    <section id="wrapper">
        ...
        <div class="wrapper">
            <div class="inner">
                <h3 class="major">{{major1}}</h3>
                <p>{{content1}}</p>
                <p>{{content2}}</p>
                <h3 class="major">{{major2}}</h3>
                <p>{{content3}}</p>
                <section class="features">
                    <article v-for="object in objects" v-bind:key="object.index">
                        <a v-bind:href="noneUrl" class="image">
                            <img v-bind:src="object.objectName.link" alt="">
                        </a>
                        <h3 class="major">{{object.objectName.name}}</h3>
                        <p>{{object.objectName.des}}</p>
                        <a v-bind:href="noneUrl" class="special">{{more}}</a>
                    </article>
                </section>
            </div>
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            major1: 'Lorem ipsum dolor',
            content1: 'Morbi mattis mi consectetur tortor elementum, varius pellentesque velit convallis. Aenean tincidunt lectus auctor mauris maximus, ac scelerisque ipsum tempor. Duis vulputate ex et ex tincidunt, quis lacinia velit aliquet. Duis non efficitur nisi, id malesuada justo. Maecenas sagittis felis ac sagittis semper. Curabitur purus leo donec vel dolor at arcu tincidunt bibendum. Interdum et malesuada fames ac ante ipsum primis in faucibus. Fusce ut aliquet justo. Donec id neque ipsum. Integer eget ultricies odio. Nam vel ex a orci fringilla tincidunt. Aliquam eleifend ligula non velit accumsan cursus. Etiam ut gravida sapien.',
            content2: 'Vestibulum ultrices risus velit, sit amet blandit massa auctor sit amet. Sed eu lectus sem. Phasellus in odio at ipsum porttitor mollis id vel diam. Praesent sit amet posuere risus, eu faucibus lectus. Vivamus ex ligula, tempus pulvinar ipsum in, auctor porta quam. Proin nec commodo, vel scelerisque nisi scelerisque. Suspendisse id quam vel tortor tincidunt suscipit. Nullam auctor orci eu dolor consectetur, interdum ullamcorper ante tincidunt. Mauris felis nec felis elementum varius.',
            major2: 'Vitae phasellus',
            content3: 'Cras mattis ante fermentum, malesuada neque vitae, eleifend erat. Phasellus non pulvinar erat. Fusce tincidunt, nisl eget mattis egestas, purus ipsum consequat orci, sit amet lobortis lorem lacus in tellus. Sed ac elementum arcu. Quisque placerat auctor laoreet.',
            more: 'Learn more',
            noneUrl: '#',
            objects: [
                {objectName: {
                    'link': require('../../images/pic04.jpg'),
                    'name': 'Sed feugiat lorem',
                    'des': 'Lorem ipsum dolor sit amet, consectetur adipiscing vehicula id nulla dignissim dapibus ultrices.'
                    }
                },
                {objectName: {
                    'link': require('../../images/pic05.jpg'),
                    'name': 'Nisl placerat',
                    'des': 'Lorem ipsum dolor sit amet, consectetur adipiscing vehicula id nulla dignissim dapibus ultrices.'
                    }
                }
